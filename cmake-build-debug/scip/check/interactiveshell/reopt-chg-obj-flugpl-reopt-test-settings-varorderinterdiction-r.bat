...
optimize
read D:/scipoptsuite-9.1.0/scipoptsuite-9.1.0/scip/check/instances/MIP/flugpl_reopt/flugpl_1.diff
optimize
validatesolve -75 -75
read D:/scipoptsuite-9.1.0/scipoptsuite-9.1.0/scip/check/instances/MIP/flugpl_reopt/flugpl_2.diff
optimize
